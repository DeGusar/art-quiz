...
import { createQuestionsAuthorPage, createQuestionsPicturesPage, questionsAuthorPage } from './questionsAuthorsPage';

import { saves } from './saves';
import {
  createResultPage, createResultPagePictures, resultsPage,
} from './resultsPage';
...
export const namesCategories = ['Portrait', 'Landscape', 'Still life', 'Impressionism', 'Expressionism', 'Avant-garde', 'Renaissance', 'Surrealism', 'Kitsch', 'Minimalism', 'Interior', 'Nude'];
